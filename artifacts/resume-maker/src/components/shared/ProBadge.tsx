      ...
      >
        <Badge
          ...
          style={{
            ...
            backgroundImage:
              "linear-gradient(to right, rgba(139, 92, 246, 0.9) 0%, rgba(168, 85, 247, 0.9) 50%, rgba(139, 92, 246, 0.9) 100%), linear-gradient(110deg, transparent 25%, rgba(255,255,255,0.4) 50%, transparent 75%)",
