      ...
      <style
        dangerouslySetInnerHTML={{
          __html: `
            ...
            /*
             * Template gallery: fixed viewport height on the measure root; two-col
             * sidebars paint full-bleed via ::before (flex % heights were not resolving).
             */
            ...
            /* Full-height two-col templates (Silicon Valley, Creative Pro, Two Column). */
            ...
            /* European: sidebar column fills below the header band. */
