...
export default function DashboardPage() {
  ...
  const handleCreateResume = () => {
    if (!newTitle.trim() || createResume.isPending) return;
    // Close the dialog first so the full-screen PremiumLoadingScreen (keyed off
    // createResume.isPending) shows cleanly — consistent with the templates flow.
    setCreateOpen(false);
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <CreateResumeDialog
        ...
        description="Choose a title and select your preferred prefill type for the resume templates."
      />
