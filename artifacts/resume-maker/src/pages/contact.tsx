      ...
      <main className="flex-1 mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-8 items-start">
          ...
          <motion.div 
            ...
            className="lg:col-span-3 bg-card border border-border rounded-2xl p-6 sm:p-8 shadow-sm"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid sm:grid-cols-2 gap-5">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="email" type="email" required placeholder="jane@example.com" className="h-11" />
                </div>
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@resumeai.example.com" className="text-muted-foreground text-sm hover:text-primary transition-colors mt-1 block">
