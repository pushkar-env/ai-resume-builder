          ...
          {detailsLoading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="bg-card border border-border rounded-xl p-5 shadow-sm hover:border-primary/20 transition-colors">
                ...
                <p
                  className={`font-bold text-xl mt-2 ${isCancelledRenewal ? "text-orange-600" : "text-foreground"}`}
                >
          ...
          <UserProfile
            ...
            appearance={{
              elements: {
                ...
                cardBox:
                  "w-full shadow-sm border border-border bg-card rounded-xl",
              },
            }}
          >
            <UserProfile.Page
