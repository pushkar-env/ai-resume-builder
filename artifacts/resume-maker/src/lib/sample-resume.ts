        ...
        items: [
          {
            ...
            bullets: [
              {
                text: "Led migration of payments infrastructure to Kubernetes serving 100B+ requests/year",
              ...
              {
                text: "Designed event-driven architecture reducing P99 latency by 65%",
                label: "Tech talk",
